  ...
  <div class="content-wrapper">
    <main class="content" id="post_content">
      ...
      <div class="row post-meta">
        ...
        <div class="right-half col-sm-12 col-xl-4">
          <?php $comments_count = count($comments); $comments_status = $comments_count > 0 ? $comments_count . ' comments': "No comments"; ?>
          <a class="comments" id="comments_status" href="#" title="<?php echo $comments_status; ?>"><i class="fa fa-comments mr-1"></i> <?php echo $comments_status; ?></a> <strong>&#183;</strong>
